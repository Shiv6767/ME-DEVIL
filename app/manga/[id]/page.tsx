        ...
        <div className="md:col-span-4 lg:col-span-3 space-y-6">
          ...
          <div className="flex flex-col gap-2">
            <button
              ...
              className={`w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded font-bold text-sm transition-colors ${
                isSaved 
                  ? 'bg-[#3db4f2] text-white hover:bg-[#3db4f2]/90' 
